...
@section('content')
    ...
    <div class="flex flex-col gap-4 justify-center items-center">
        <div class="join mx-auto">
            ...
            <a class="btn btn-outline text-white hover:bg-[#fff6] hover:text-white join-item"
                href="{{ url('export/adoptions/excel') }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
        ...
        <div class="flex flex-col md:flex-row gap-2 items-center mb-10">
            {{-- Filter selector --}}
            <select id="filter" class="select bg-[#0009] text-white outline outline-white">
                <option value="all">All</option>
                <option value="pet">By Pet</option>
                <option value="user">By Adopter</option>
            </select>
            {{-- Search input --}}
    ...
    <div class="flex justify-center mt-8">
        {{ $adopts->links('partial.pagination') }}
    </div>
