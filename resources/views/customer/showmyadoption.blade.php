    ...
    <div class="bg-[#0009] p-10 rounded-sm flex flex-col items-center">
        ...
        <div class="flex gap-2 flex-col md:flex-row">
            ...
            <ul class="list bg-[#0006] mt-4 text-white rounded-box shadow-md w-64">
                <li class="p-3 text-center font-bold text-[#fff9] border-b border-white/10">Adopter</li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Document:</span>
                    <span>{{ $adopt->user->document }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">FullName:</span>
                    <span>{{ $adopt->user->fullname }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Gender:</span>
                    <span>{{ $adopt->user->gender }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Age:</span>
                    <span>{{ Carbon\Carbon::parse($adopt->user->birthdate)->age }} years old</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Phone:</span>
                    <span>{{ $adopt->user->phone }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Email:</span>
                    <span>{{ $adopt->user->email }}</span>
                </li>
                <li class="list-row">
            ...
            {{-- Pet info --}}
            <ul class="list bg-[#0006] mt-4 text-white rounded-box shadow-md w-64">
                <li class="p-3 text-center font-bold text-[#fff9] border-b border-white/10">Pet</li>
                <li class="list-row">
                ...
                <li class="list-row">
                    ...
                    <span>{{ $adopt->pet->breed }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Weight:</span>
                    <span>{{ $adopt->pet->weight }} kg</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Age:</span>
                    <span>{{ $adopt->pet->age }} years old</span>
                </li>
                <li class="list-row">
